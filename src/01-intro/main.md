...
- Там може да намерите организационна информация, да питате въпроси и т.н.
  ...
  ![](./discord_server.png){ width=250px }
...
- Всеки **Петък** от **16:15** до **19:00**, зала **321** във ФМИ

- Смесваме кога е практикум и кога е семинар, ще ви предупредим

- Слайдове, задачи, ...: [github.com/universal-configurations-with-nix/fmi-2025-2026](https://github.com/universal-configurations-with-nix/fmi-2025-2026/tree/main/slides)

- Записи от минало\* водене: [youtube.com/@uni-confs-with-nix-fmi](https://youtube.com/@uni-confs-with-nix-fmi)
